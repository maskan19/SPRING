...
/**
 * 접근 제어를 통한 자원의 보호 1. 인증(authentication) : 본인 여부를 확인하는 신원 확인 절차 2.
 * 인가(authorization) : 보호 자원에 접근할 수 있는 역할이 부여되어있는지 여부 확인하는 절차(권한 확인)
 *
 */
public class AuthenticationFilter implements Filter {
	...
	public void init(FilterConfig filterConfig) throws ServletException {
		...
		try (InputStream is = AuthenticationFilter.class.getResourceAsStream(resPath);
