      ...
      <tr>
         ...
         <td>
            <select name="prod_lgu">
               ...
               <c:set var="selected" value='${lprod.lprod_gu eq prod.prod_lgu ? "selected": "" }'></c:set> <!-- 속성선언 -->
      ...
      <tr>
         ...
         <select name="prod_buyer">
            ...
            <c:forEach items="${buyerList }" var="buyer">
               <c:set var="selected" value="${buyer.buyer_id eq prod.prod_buyer ? 'selected': '' }"></c:set> <!-- 속성선언 -->
