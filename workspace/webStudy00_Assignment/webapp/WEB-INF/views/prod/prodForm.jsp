   ...
   <table>
      <tr>
         ...
         <td><input type="text" name="prod_name" required
            value="<%=Objects.toString(prod.getProd_name(),"")%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_name"),"")%></span></td>
      </tr>
<!--       ===================== -->
      <tr>
         <th>분류코드</th>
         <td>
            ...
            <span class="error"><%=Objects.toString(errors.get("prod_lgu"),"")%></span></td>
      </tr>
      <tr>
         <th>거래처</th>
         <td>
         <select name="prod_buyer">
            ...
            <span class="error"><%=Objects.toString(errors.get("prod_buyer"),"")%></span></td>
      </tr>
<!--       ===================== -->
      <tr>
         <th>구매가</th>
         <td><input type="number" name="prod_cost" required
            ...
            <span class="error"><%=Objects.toString(errors.get("prod_cost"),"")%></span></td>
      </tr>
      <tr>
         <th>판매가</th>
         <td><input type="number" name="prod_price" required
            value="<%=prod.getProd_price()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_price"),"")%></span></td>
      </tr>
      <tr>
         <th>세일가</th>
         <td><input type="number" name="prod_sale" required
            value="<%=prod.getProd_sale()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_sale"),"")%></span></td>
      </tr>
      <tr>
         <th>상품정보</th>
         <td><input type="text" name="prod_outline" required
            value="<%=prod.getProd_outline()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_outline"),"")%></span></td>
      </tr>
      <tr>
         <th>상세정보</th>
         <td><input type="text" name="prod_detail"
            value="<%=prod.getProd_detail()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_detail"),"")%></span></td>
      </tr>
      <tr>
         <th>이미지</th>
         <td><input type="text" name="prod_img" required
            value="<%=prod.getProd_img()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_img"),"")%></span></td>
      </tr>
      <tr>
         <th>재고</th>
         <td><input type="number" name="prod_totalstock" required
            value="<%=prod.getProd_totalstock()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_totalstock"),"")%></span></td>
      </tr>
      <tr>
         <th>적정재고</th>
         <td><input type="number" name="prod_properstock" required
            value="<%=prod.getProd_properstock()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_properstock"),"")%></span></td>
      </tr>
      <tr>
         <th>크기</th>
         <td><input type="text" name="prod_size"
            value="<%=prod.getProd_size()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_size"),"")%></span></td>
      </tr>
      <tr>
         <th>색상</th>
         <td><input type="text" name="prod_color"
            value="<%=prod.getProd_color()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_color"),"")%></span></td>
      </tr>
      <tr>
         <th>배송방법</th>
         <td><input type="text" name="prod_delivery"
            value="<%=prod.getProd_delivery()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_delivery"),"")%></span></td>
      </tr>
      <tr>
         <th>단위</th>
         <td><input type="text" name="prod_unit"
            value="<%=prod.getProd_unit()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_unit"),"")%></span></td>
      </tr>
      <tr>
         <th>입고량</th>
         <td><input type="number" name="prod_qtyin"
            value="<%=prod.getProd_qtyin()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_qtyin"),"")%></span></td>
      </tr>
      <tr>
         <th>판매량</th>
         <td><input type="number" name="prod_qtysale"
            value="<%=prod.getProd_qtysale()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_qtysale"),"")%></span></td>
      </tr>
      <tr>
         <th>마일리지</th>
         <td><input type="number" name="prod_mileage"
            value="<%=prod.getProd_mileage()%>" />
            <span class="error"><%=Objects.toString(errors.get("prod_mileage"),"")%></span></td>
      </tr>
      <tr>
         <td colspan="2">
