 ...
 *  2. 인가(authorization) : 보호 자원에 접근할 수 잇는 역할이 부여되어있는지 여부 확인하는 절차(권한 확인)
 *  
 */
public class AuthenticationFilter implements Filter{

   private static final Logger logger = LoggerFactory.getLogger(AuthenticationFilter.class);
   public static final String RESOURCEMAPNAME = "seuredResources";
   ...
   public void init(FilterConfig filterConfig) throws ServletException {
      ...
      try(
         ...
         for(Entry<Object, Object> entry : properties.entrySet()) {
            ...
            Arrays.sort(roles);//미리 정렬해두어서 binarysearch 쓸 수 있게 함
   ...
   @Override
   public void destroy() {
      logger.info("{} 필터 소면", getClass().getName());
