	...
	<table>
		...
		<tr>
			<td colspan="2">
				...
				<button type="button" onclick="location.href='prodUpdate.do?what=${prod.prod_id}';">수정</button>
				<button type="button" onclick="location.href='${cPath}/prod/prodDelete.do';">삭제</button>
			</td>
		</tr>
	</table>
</body>
