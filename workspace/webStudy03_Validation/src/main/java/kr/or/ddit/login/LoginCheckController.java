...
public class LoginCheckController {
	...
	public String doPost(@RequestParam(value = "mem_id", required = true) String mem_id,
			@RequestParam(value = "mem_pass", required = true) String mem_pass,
			@RequestParam(value = "saveId", required = false) String saveId, HttpServletRequest req,
