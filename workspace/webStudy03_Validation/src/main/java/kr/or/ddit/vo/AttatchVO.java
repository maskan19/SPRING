...
public class AttatchVO implements Serializable {
	...
	//파일 삭제 메서드
//	public void deleteAt(File saveFolder) throws IOException {
//		System.out.println("경로 : " + saveFolder.getAbsolutePath());
//		System.out.println("파일명 : " + att_savename);
//		file.deleteAt(saveFolder, att_savename);
//	}
